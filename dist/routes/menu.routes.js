...
import { createMenu, getAllMenus, getMenuById, updateMenu, deleteMenu, } from '../controllers/menu.controller.js';
import { protect, restrictTo } from '../middlewares/auth.middleware.js';
import { validate } from '../middlewares/validate.middleware.js';
import { createMenuSchema, updateMenuSchema, getMenuSchema, } from '../validations/menu.validation.js';
const router = Router();
router.use(protect);
