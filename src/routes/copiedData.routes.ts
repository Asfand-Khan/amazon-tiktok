...
import {
  createCopiedDataSchema,
  updateCopiedDataSchema,
} from '../validations/copiedData.validation.js';
...
router.post(
  '/',
  validate(createCopiedDataSchema),
  copiedDataController.createCopiedData
);
router.get('/', copiedDataController.getMyCopiedData);
router.get('/:id', copiedDataController.getCopiedDataById);
router.patch(
  '/:id',
  validate(updateCopiedDataSchema),
  copiedDataController.updateCopiedData
);
